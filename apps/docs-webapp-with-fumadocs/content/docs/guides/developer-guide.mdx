---
title: "FSM Framework — Developer Guide"
description: "In-repo development guide for building and debugging fsm-compiler-ts, fsm-sync-worker-ts, and fsm-core-async-op-worker from source with deno run."
---
...
<p align="center">
  <a href="https://github.com/pgfsm/fsm/blob/main/CONTRIBUTING.md"><img src="https://img.shields.io/badge/PRs-welcome-brightgreen.svg" alt="PRs welcome"/></a>
  <a href="https://github.com/pgfsm/fsm/blob/main/LICENSE"><img src="https://img.shields.io/badge/license-Apache--2.0-blue.svg" alt="License: Apache-2.0"/></a>
</p>
...
> [README.md](/docs/getting-started) instead — same lifecycle, `npx`-first.
...
[`packages/database-src/fsm.machine.schema.v3.json`](https://github.com/pgfsm/fsm/blob/main/packages/database-src/fsm.machine.schema.v3.json)

Format guide:
[`fsm-definition-format.md`](/docs/packages/fsm-compiler-ts/reference/fsm-definition-format).

Example :
[apps/fsm-core-example/fsm/creditCheck/v01/](https://github.com/pgfsm/fsm/tree/main/apps/fsm-core-example/fsm/creditCheck/v01)
...
| PRD                 | [PRD-002](/docs/packages/fsm-compiler-ts/prd/prd-002-scaffold-async-operation-logic)                                                                                        | [PRD-003](/docs/packages/fsm-compiler-ts/prd/prd-003-scaffold-sync-operation-logic)                                                                                  |
...
| Command             | `deno run --allow-all packages/fsm-compiler-ts/src/cli/index.ts -c generate-async-logic -f apps/fsm-core-example/fsm --plugin-root apps/fsm-core-example`                       | `deno run --allow-all packages/fsm-compiler-ts/src/cli/index.ts -c generate-sync-logic -f apps/fsm-core-example/fsm`                                                     |
...
See the compiler [TODO](/docs/packages/fsm-compiler-ts/todo/todo) for both
planned-gap items.
...
(`<plugin-root>/worker-sdk-generated/<lang>/`, see the table above), not
re-walked to find actors and independent of where `-f`/`-o` point; both modes
refresh the aggregate now, not just directory mode. See
[`cli-usage.md`](/docs/packages/fsm-compiler-ts/guides/cli-usage) for
...
[`fsm-proto-codegen`](/docs/packages/fsm-proto-codegen) via `buf generate`,
...
package's [README](/docs/packages/fsm-proto-codegen) for the per-language
plugin setup.
...
| Worker Arch ADR             | [ADR-003](/docs/architecture/adr/adr-003-fsm-async-operation-polyglot-actor-execution-model)                                                                                                                                                                                     | [ADR-002](/docs/architecture/adr/adr-002-fsm-sync-operation-worker-execution-model)                                                                                                                                                                               |
...
[`CLI-USAGE.md`](/docs/packages/fsm-core-async-op-worker/guides/cli-usage)
...
this path; see above). Each connects to the gateway's `--sidecar-socket` above
and serves invocations for every actor compiled into its registry until stopped.
...
See [`CLI-USAGE.md`](/docs/packages/fsm-sync-worker-ts/guides/cli-usage)
...
[`docs/specs/spec-003-pgcron-fsm-scheduler.md`](/docs/architecture/specs/spec-003-pgcron-fsm-scheduler).
...
| Worker Arch ADR             | [ADR-003](/docs/architecture/adr/adr-003-fsm-async-operation-polyglot-actor-execution-model)                                                                                                                                                                                           |
...
[`CLI-USAGE.md`](/docs/packages/fsm-async-worker-ts/guides/cli-usage) for
...
See [`CLI-USAGE.md`](/docs/packages/fsm-async-worker-ts/guides/cli-usage)
...
- Compiler CLI —
  [`cli-usage.md`](/docs/packages/fsm-compiler-ts/guides/cli-usage)
- Sync worker CLI —
  [`CLI-USAGE.md`](/docs/packages/fsm-sync-worker-ts/guides/cli-usage)
- Async-operation worker CLI (current) —
  [`CLI-USAGE.md`](/docs/packages/fsm-core-async-op-worker/guides/cli-usage)
- Async-operation worker CLI (old, superseded) —
  [`CLI-USAGE.md`](/docs/packages/fsm-async-worker-ts/guides/cli-usage)
- Proto codegen (gateway wire stubs) —
  [`fsm-proto-codegen/README.md`](/docs/packages/fsm-proto-codegen)
- Worker control plane —
  [`adr-002-fsm-sync-operation-worker-execution-model.md`](/docs/architecture/adr/adr-002-fsm-sync-operation-worker-execution-model)
- Polyglot direction —
  [`adr-003-fsm-async-operation-polyglot-actor-execution-model.md`](/docs/architecture/adr/adr-003-fsm-async-operation-polyglot-actor-execution-model)
