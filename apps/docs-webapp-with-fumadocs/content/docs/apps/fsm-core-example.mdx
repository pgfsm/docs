---
title: "fsm-core-example — Example FSM Definitions"
description: "Reference FSM definitions -- creditCheck, carVitals, taskMachineConfig, vitalsWorkflow -- used for development and testing."
---
...
the root [DEVELOPER.md](/docs/guides/developer-guide) for the full quick-start flow
...
1. Create `fsm/<yourAsyncOperationName>/v01/fsm.json` (see
   [FSM definition format](/docs/packages/fsm-compiler-ts/reference/fsm-definition-format))
