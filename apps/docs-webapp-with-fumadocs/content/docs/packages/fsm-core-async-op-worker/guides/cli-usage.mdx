---
title: "fsm-core-async-op-worker — CLI Usage Guide"
description: "Usage reference for the async-operation-worker-gateway process and its -ctl companion CLI."
---
...
`send_to_parent_result: {"skipped": true, "reason": "no real parent to notify"}`
