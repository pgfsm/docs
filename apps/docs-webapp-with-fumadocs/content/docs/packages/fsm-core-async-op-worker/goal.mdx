---
title: "Goal: `fsm-core-async-op-worker`"
description: "Scoping and design record for fsm-core-async-op-worker as a standalone alternative to fsm-async-worker-ts."
---
