---
title: "fsm-logging-ts — Shared Logging Foundation"
description: "The single owner of logging config for the repo, wrapping LogTape with one configurator and a shared category vocabulary."
---
