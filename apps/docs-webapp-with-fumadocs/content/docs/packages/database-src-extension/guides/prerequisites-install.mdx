---
title: "pgrx (Rust-based Postgres Extension Tool) Prerequisites on macOS"
description: "macOS prerequisites for building PostgreSQL extensions in Rust with pgrx."
---
