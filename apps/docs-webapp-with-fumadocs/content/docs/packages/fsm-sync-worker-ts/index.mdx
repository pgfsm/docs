---
title: "@pgfsm/sync-worker"
description: "The out-of-band worker fleet -- fsmlet, fsmscheduler, fsmctl, and a pg_cron alternative -- that drives FSM instances forward."
---
