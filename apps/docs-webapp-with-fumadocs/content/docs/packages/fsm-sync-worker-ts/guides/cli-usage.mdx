---
title: "fsm-sync-worker-ts — CLI Usage Guide"
description: "Usage reference for the package's four CLIs: fsmlet, fsmscheduler, fsmctl, and pgcron."
---
...
> package — see
> [`fsm-async-worker-ts/docs/guides/CLI-USAGE.md`](/docs/packages/fsm-async-worker-ts/guides/cli-usage).
...
[`fsm-async-worker-ts/docs/guides/CLI-USAGE.md`](/docs/packages/fsm-async-worker-ts/guides/cli-usage#denojson-tasks).
