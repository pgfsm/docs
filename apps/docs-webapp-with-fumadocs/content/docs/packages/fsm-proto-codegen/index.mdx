---
title: "@pgfsm/proto-codegen"
description: "Buf-driven .proto to multi-language stub generation, and the source-of-truth home for this repo's .proto contracts."
---
...
[SPEC-002](/docs/architecture/specs/spec-002-proto-contracts-in-codegen-package)).
