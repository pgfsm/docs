---
title: "PostgreSQL v1 Functions — `p_*` Argument Rename Suggestions"
description: "Suggested p_ to input_ argument renames for v1 functions, provided for completeness and not applied to the v1 schema."
---

These are rename suggestions for v1 functions only. V1 functions are superseded
by v2 and have no TypeScript wrappers — these are provided for completeness.
Changes are **not applied** to v1 schema files.
