---
title: "ADR-001: Do Not Use PostgreSQL Row Security Policies (RLS) in fsm_core"
description: "Decision not to use PostgreSQL Row Level Security policies in fsm_core."
---
