---
title: "fsm-compiler-ts — TODO"
description: "Gaps tracked against the compiler's PRDs, including adopting schema v3 and wiring fsmLanguage."
---

Gaps tracked against the compiler PRDs in [`../prd/`](https://github.com/pgfsm/fsm/tree/main/packages/fsm-compiler-ts/docs/prd):

- [PRD-001: Design your FSM JSON schema](/docs/packages/fsm-compiler-ts/prd/prd-001-design-fsm-json-schema)
- [PRD-002: Scaffold async operation logic](/docs/packages/fsm-compiler-ts/prd/prd-002-scaffold-async-operation-logic)
- [PRD-003: Scaffold sync operation logic](/docs/packages/fsm-compiler-ts/prd/prd-003-scaffold-sync-operation-logic)
- [PRD-004: Validate async operation logic](/docs/packages/fsm-compiler-ts/prd/prd-004-validate-async-operation-logic)
- [PRD-005: Validate sync operation logic](/docs/packages/fsm-compiler-ts/prd/prd-005-validate-sync-operation-logic)
