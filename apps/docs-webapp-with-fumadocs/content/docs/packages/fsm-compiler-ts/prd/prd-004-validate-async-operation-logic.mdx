---
title: "PRD-004 — Validate async operation logic"
description: "Product requirements for validating that implemented async operation logic matches its fsm.json declarations."
---

**Package:** `@pgfsm/compiler` (`packages/fsm-compiler-ts`) **Status:**
Implemented — see [Gaps](#gaps) and [TODO.md](/docs/packages/fsm-compiler-ts/todo/todo). **Related:**
