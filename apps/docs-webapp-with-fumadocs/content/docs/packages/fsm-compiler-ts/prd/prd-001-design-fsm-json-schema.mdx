---
title: "PRD — Design your FSM JSON schema"
description: "Product requirements for designing and validating the versioned fsm.json that PostgreSQL loads and executes."
---
...
§1 of the root [`DEVELOPER.md`](/docs/guides/developer-guide).
...
canonical schema is
[`fsm.machine.schema.v3.json`](https://github.com/pgfsm/fsm/blob/main/packages/database-src/fsm.machine.schema.v3.json).

See the [FSM Definition Format](/docs/packages/fsm-compiler-ts/reference/fsm-definition-format) reference
