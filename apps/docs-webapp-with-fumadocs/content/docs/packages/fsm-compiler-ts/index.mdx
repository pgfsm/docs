---
title: "@pgfsm/compiler"
description: "FSM JSON compiler for PostgreSQL-backed state machines: generates fsm.json, scaffolds operation-logic stubs, validates them, and loads the result into the database."
---
...
is documented in
[`docs/reference/fsm-definition-format.md`](/docs/packages/fsm-compiler-ts/reference/fsm-definition-format).
