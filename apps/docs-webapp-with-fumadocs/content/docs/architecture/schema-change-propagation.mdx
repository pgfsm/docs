---
title: "Schema Change Propagation"
description: "How a schema edit in packages/database-src propagates through generated types to every downstream package that consumes them."
---
