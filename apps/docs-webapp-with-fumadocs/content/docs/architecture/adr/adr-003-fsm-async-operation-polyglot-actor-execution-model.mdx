---
title: "ADR-003: Polyglot Actor Execution Model — Activity-Tier Architecture & Compiled-Language IPC"
description: "Activity-tier architecture and compiled-language IPC decisions for running polyglot (TypeScript/Python/Rust/Go) actor workers."
---
...
| Related    | [ADR-002](/docs/architecture/adr/adr-002-fsm-sync-operation-worker-execution-model) — orchestrator tier (this ADR is its activity-tier counterpart); Issues #55, #61, #84   |
