---
title: "ADR-002: FSM Worker Execution Model Evolution"
description: "Evolution of the FSM sync-operation worker's process model and dispatch strategy through three stages."
---
...
> [ADR-003](/docs/architecture/adr/adr-003-fsm-async-operation-polyglot-actor-execution-model) for
