---
title: "Limitation: pgmq Queue Name Length (47 characters)"
description: "pgmq's internal table-name prefixing caps partitioned queue names at 47 characters, constraining FSM and async-operation naming conventions."
---
